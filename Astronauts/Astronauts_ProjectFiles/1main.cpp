    ...
    switch(ch)
    {
        case 1:
        {
            ...
            while(Stock_Directory1>>ID>>product_name>>weight>>Unit_price>>buying_price>>selling_price>>Quantity>>profit_per_unit)
            {
                    ...
                    cout<<"\n\t\t\t\t\t|  ID   |         NAME          |    WEIGHT     |TOTAL BOUGHT UNIT|";
                    cout<<"\n\t\t\t\t\t___________________________________________________________________\n";
...
void create_new_invoice()
{
    ...
    FILE *tempfile22;
    tempfile22= fopen("temporary_invoice.txt", "w");
    while(fscanf(tempfile22, "%s %s %s %s %s", &s1, &s2, &s3, &s4, &s5)!=EOF)
    {
        fprintf(tempfile22, "%s %s %s %s %s", &s1, &s2, &s3, &s4, &s5);
                   
    }

   // ofstream refund22("temporary_invoice.txt",ios::app);
    //while(refundd22>>s1>>s2>>s3>>s4>>s5)
        //refund22<<'\n';
...
void product_management()
{
    FILE *Productfile1_8;
    char product_name[100];
    int Quantity, ID,choice,editpart_no,Q1,Q2,del_ID, edition_choice;
    float Unit_price, buying_price, selling_price, current_BP, current_SP, edited_sp, edited_bp, edited_quantity;
    Productfile1_8 = fopen("productinfo.txt" , "a");
    printf("Product Managing Section\n\n");
    printf("01.Add a New Product\n");
    ...
    printf("Enter your choice how you want to edit:");
    scanf("%d" , &choice);
    //edit by product name
    if(choice==1 || choice==2)
    {   if(choice ==1 )
       ...
       scanf("%d" , &ID);
        ...
        scanf("%d" , &editpart_no);
        if(editpart_no==1){
            printf("\nYou can edit quantity by this process given below:\n");
            printf("01.Reduce Product Quantity\n");
            printf("02.Increase product Quantity\n");
            printf("\nEnter your choice please: ");
            scanf("%d" , &edition_choice);
            if(edition_choice==1){
               printf("\n\nCurrent quantity : ");//need manually showed
               scanf("%d" , &Q1);
               printf("Enter how much quantity you reduce: ");
               scanf("%d" ,&Q2);
              int edited_quantity = Q1-Q2;
               printf("Edited quantity = %d\n" , edited_quantity);
               if(choice==1)
          {
           ...
           fprintf(Productfile1_8, "\n%d %d" ,ID,edited_quantity);
                 ...
                 scanf("%d" , &Q1);
                 printf("How much quantity you want to Increase:");
                 scanf("%d" ,&Q2);
                 int edited_quantity = Q1+Q2;
                 printf("Edited quantity = %d\n",edited_quantity );
           if(choice==1)
            ...
            printf("\nYou can edit Buying Price by this process given below:\n");
            printf("01.Reduce Product Buying price\n");
            printf("02.Increase product Buying price\n");
            printf("\nEnter your choice please: ");
            scanf("%d" , &edition_choice);
            if(edition_choice==1)
            {
                printf("Current Buying price per unit: ");
                scanf("%f" , &current_BP);
                printf("Enter Buying price per unit to reduce:");
                scanf("%f" ,&buying_price);
                float edited_bp = current_BP - buying_price;
                printf("Edited Buying price per unit = %.2f\n" ,edited_bp );
                if(choice==1)
               fprintf(Productfile1_8, "\n%s %.2f" ,product_name,edited_bp);
               else if(choice==2)
                fprintf(Productfile1_8, "\n%d %.f" ,ID,edited_bp);
            ...
            scanf("%f" ,&buying_price);
            float edited_bp = current_BP + buying_price;
            printf("Edited Buying price per unit = %.f\n" ,edited_bp );
            if(choice==1)
            fprintf(Productfile1_8, "\n%s %.2f" ,product_name,edited_bp);
            else if(choice==2)
                fprintf(Productfile1_8, "\n%d %.2f" ,ID,edited_bp);
            }
            printf("Buying price per unit edited successfully!\n");
        }
        else if(editpart_no==3){
            printf("\nYou can edit Selling Price by this process given below:\n");
            printf("01.Reduce Product Selling price\n");
            printf("02.Increase product Selling price\n");
            printf("\nEnter your choice please: ");
            scanf("%d" , &edition_choice);
            if(edition_choice==1){
            printf("Current Selling price per unit: ");
            scanf("%f" , &current_SP);
            printf("Enter Selling price per unit to reduce:");
            scanf("%f" ,&selling_price);
            float edited_sp = current_SP - selling_price;
            printf("Edited Selling price per unit = %.2f\n" ,edited_sp );
            if(choice==1)
            fprintf(Productfile1_8, "\n%s %.2f" ,product_name,edited_sp);
            else if(choice==2)
                fprintf(Productfile1_8, "\n%d %.2f" ,ID,edited_sp);
